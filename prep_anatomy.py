...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec  7 22:55:16 2018

@author: Rudi Kreidenhuber

input is a freesurfer folder --> generates source model
"""

#import mne
#
## anat = "/Users/idrael/MEG_playground/RK21051985_test/anat/"
#subject = 'RK21051985'
#
## mne.utils.set_config("SUBJECTS_DIR", anat, set_env=True)
#
#src = mne.setup_source_space(subject, spacing='oct6')
#mne.write_source_spaces(subject + '-oct6-src.fif', src)
#
#model = mne.make_bem_model(subject)
#mne.write_bem_surfaces(subject + '_bem.fif', model)
#
#
#
#
### Funktion, die als Argument Subj-ID, Spacing und optional den Ordner bekommt
### und dann die source space berechnung macht.
...
data_path = '/Users/idrael/MEG_playground/RK21051985_test'

# the raw file containing the channel location + types
raw_fname = data_path + '/data/RK21051985_index.fif'
# The paths to Freesurfer reconstructions
subjects_dir = data_path + '/anat/'
subject = 'RK21051985'
